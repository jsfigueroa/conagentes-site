...
export const metadata: Metadata = {
  // Brand-suffixed by the root layout template — no "conagentes" prefix here.
  title: "Agentes IA para su negocio",
  description:
    "Agentes IA que atienden, venden, agendan y hacen seguimiento por WhatsApp — 24/7, sin contratar más gente. Para comercios, servicios, clínicas y academias en Colombia. (Nuestra especialidad son los hoteles y alojamientos.)",
  keywords: [
    "agente IA WhatsApp",
