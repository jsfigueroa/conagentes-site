...
export async function GET() {
  ...
  out();
  out(
    "Vocabulario de estados que conagentes usa siempre, sin excepción: «en vivo» = funciona hoy (WhatsApp, Instagram, chat web, PMS incluido, cotización con disponibilidad real, cobros Wompi y Mercado Pago, agenda de servicios, upsell, reactivación, factura electrónica DIAN, registro de huéspedes TRA, BI por WhatsApp); «en piloto» = construido y activándose (mensajería de OTAs, Revenue Manager, agente de voz, conexión con PMS externos y Channex); «en construcción» = todavía no disponible (reporte SIRE a Migración Colombia)."
  );
  out();
